...
public class RiverScrolling : MonoBehaviour
{
    ...
    public void Initialize(RiverGenerator generator, ComplicationSettings complication, MonoGridPresenter presenter, List<EnvironmentToDestroy> startEnvironment = default)
    {
